...
import { HomeIcon, MessageSquareMoreIcon, PlusIcon, SearchIcon, Share2Icon, ThumbsDownIcon, ThumbsUpIcon, UserIcon } from 'lucide-react'
      ...
      >
        <CarouselContent className="h-screen">
          {Array.from({ length: 4 }).map((_, index) => (
            <CarouselItem key={index} className={cn( 'h-full w-full flex  flex-col items-center gap-15 pt-30 relative')}>
              ...
              <Image
                ...
                height={150}
                />
                <p className='font-bold'>宇宙から来たラマ</p>
                </div>
                <div className='flex flex-col items-center justify-center p-4 rounded-2xl gap-2 backdrop-blur-md'>
              ...
              <Image
                ...
                height={150}
                />
                <p className='font-bold columns-1'>トナカイと暮らしたトミー</p>
                </div>
                </div>
              <div className="absolute right-3 bottom-30 z-50 flex flex-col gap-4">
                <Button onClick={()=>router.push("/1111")} size="icon" variant="outline" className="rounded-full size-10">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-purple-600 to-[#3B82F6]  flex items-center justify-center shadow-2xl relative overflow-hidden">
          ...
          <div className="absolute top-2 left-4 w-8 h-4 rounded-full bg-white/30 blur-md"></div>
                ...
                >
                  <ThumbsUpIcon className={cn("size-5", liked ? "text-white" : "")} />
                </Button>
                <Button 
                  size="icon" 
                  variant="outline" 
                ...
                >
                  <ThumbsDownIcon className={cn("size-5", disliked ? "text-white" : "")} />
                </Button>
                <Button size="icon" variant="outline" className="rounded-full bg-[#0E0B16] size-10">
